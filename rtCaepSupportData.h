...
/*------------------------------------*/
/* CaeUnsRecomb2DPoly format item setup data */
/*------------------------------------*/
CAEP_BCINFO CaeUnsRecomb2DPolyBCInfo[] = {
    { "inlet",   100 },
    { "outlet", 101 },
    { "wall",  102 },
};
/*------------------------------------*/
CAEP_VCINFO CaeUnsRecomb2DPolyVCInfo[] = {
    { "fluid",   200 },
    { "plasma", 201 },
    { "solid",  202 },
};
/*------------------------------------*/
const char *CaeUnsRecomb2DPolyFileExt[] = {
    "glf"
};
/*! \endcond */
...
\skip == CAEP_BCINFO*
\until ARRAYSIZE(CaeUnsRecomb2DPolyFileExt)
*/
