...
*/
#define ID_CaeUnsRecomb2DPoly  1119
{
    /*== CAEP_FORMATINFO FormatInfo */
    {   PWP_SITE_GROUPNAME,     /* const char *group */
        "Recomb2DPoly",             /* const char *name */
        MAKEGUID(ID_CaeUnsRecomb2DPoly),  /* PWP_UINT32 id */
    ...
    CaeUnsRecomb2DPolyBCInfo,            /* CAEP_BCINFO* */
    ARRAYSIZE(CaeUnsRecomb2DPolyBCInfo), /* PWP_UINT32 BCCnt */

    /*== CAEP_VCINFO*    pVCInfo;    -- array of format VCs or NULL */
    /*== PWP_UINT32      VCCnt;      -- # format VCs */
    CaeUnsRecomb2DPolyVCInfo,            /* CAEP_VCINFO* pVCInfo */
    ARRAYSIZE(CaeUnsRecomb2DPolyVCInfo), /* PWP_UINT32 VCCnt */

    /*== const char**    pFileExt;   -- array of valid file extensions */
    /*== PWP_UINT32      ExtCnt;     -- # valid file extensions */
    CaeUnsRecomb2DPolyFileExt,            /* const char **pFileExt */
    ARRAYSIZE(CaeUnsRecomb2DPolyFileExt), /* PWP_UINT32 ExtCnt */
